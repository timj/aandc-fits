...
WCS may be considered to be part of it. These standard semantics are generally 
...
goes from HDF5, which does not supply any data model per se, to that of NDF/HDS 
...
more detailed than the metadata in the FITS standard. On the other hand, NDF does 
not have any native ability to contain tabular data and FITS is certainly more 
widely adopted than NDF.  Extended FITS models also suffer from the same lack of 
universal uptake. Nevertheless, we believe FITS would benefit from an expansion 
in its standard data model as there are certainly common semantics which 
may be found in all of these other non-standard FITS data models which the 
