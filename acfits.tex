...
data was naturally adopted for FITS data model.  Although the tapes
...
TBs.  Servicing such data as images in FITS is going to encounter
significant performance fallbacks due to inability of FITS to provide
an acceptable performance for the data-cubes large than just a few GB.
