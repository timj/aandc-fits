...
A reasonable framework should be to support multiple representations of the same data
(e.g.\ multiple resolutions or fidelities), preferably from a single master file. It should also
be possible to stream the data progressively to the end-user, displaying an image as soon
as the first data becomes available.
...
a comprehensive framework for encoded data, which has led to it falling behind any modern imaginary format.
