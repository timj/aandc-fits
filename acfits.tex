...
Finally the community needs to not forget FITS strengths.
In particular, FITS inclusion of semantic content (data models) as part of the
standard should continue to be pushed. There are many critical missing data
models (section~\ref{section_crit_data_models}) that, if included in the standard, 
