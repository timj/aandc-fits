...
things like ``table'' and ``n-dimensional array'', the later which is 
...
While these structures do provide for the capture of semantic information 
(such as in the form of table column keywords) an additional data model 
(or models) must still be created or implemented by the author of the FITS
...
these models. We detail several important missing data models in this 
section below.
