...
\citealt{1979ipia.coll..445W,1981A&AS...44..363W} and
...
readers that do not use the \texttt{cfitsio} library (ascl:1010.001) and
which utilize C routines to implement other scientific capabilities.
...
data products into FITS files, without reprocessing it to the specified
...
records of astronomical observations, the less the data is altered, the more
efficient and reliable the archival data management will be.
...
e.g.][ascl:1010.002]{2000ASPC..216..551P,2007ASPC..376..483S,2009PASP..121..414P}.
