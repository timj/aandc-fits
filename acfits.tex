...
libraries in which particular variants are supported fully, partially 
or not at all.

This is partly due to the lack of good validating tools
...
At least some of the interoperability problems are of the community's own making, and however the community resolves the problems discussed in this article, it seems clear that a more rigorous approach to validation, and a minimal tolerance of non-standard files, will be necessary."

%This issue will not be solved with a
