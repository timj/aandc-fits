...
It is clear then that there is a pressing need for name\-spaced data models,
...
be documented or not but are a result of either accidental an intentional 
stretching of the original metadata usage. Consider the example in 
Fig.~\ref{fig:fitshead} which is an informal variant because of its non-standard 
...
papers \citep{2014Kitaeff,2014Jenness}, and offered solutions to these
problems.  Possible solutions may involve moving existing FITS
