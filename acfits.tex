...
{\color{red} \textit{This section is somewhat controversial}
...
standard. In the case of a standard like JPEG2000\footnote{\url{http://en.wikipedia.org/wiki/JPEG\_2000}}
...
{\color{red} \textit{Not sure this point is adequately supported in the text}
...
NNX12AH91H.
Finally, the authors wish to thank Bill Pence for many insightful
discussions.
