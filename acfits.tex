...
{\color{red} This para is dangerously close to suggesting fix..may need 
...
Perl's CFITSIO and Python's fitsio libraries).
...
shared API rather than format itself (HDF does this inadvertently?)
