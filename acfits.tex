...
in the file may be semantically and syntactically validated and hence
fully utilized by software programs. Questions such as ``are all of the
required metadata/data structures present in the file?'' (e.g.~all of
...
with other data'' (e.g.~can stars in the file be associated in some manner 
with galaxies in another file/extension?) is one of semantic validation. 
By confirming that the file is 'valid' in both senses, we may link the 
data model to the information in the file, and hence answer the fundemental 
question ``what does this data you gave me represent?'' (e.g.~lists 
