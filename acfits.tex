...
forward compatibility, at minimum, a reasonable expectation goes
beyond believing a FITS reader not
crash when confronted with a newer FITS file. Ideally, it should do
more than this, parsing what parts of the file are still compliant with
its understanding of the format and reporting on those parts/features
of the file which it does not recognize. In both cases, without
unambiguous version metadata, readers have to rely on `duck-typing'
