...
In this document, we have made occaisonal reference to other 
data formats in use in Astronomy. 
A fuller analysis of problems should be done in comparison to 
other data formats used in Astronomy.
}
