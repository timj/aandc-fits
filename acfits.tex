...
There are also restrictions on the expression
...
truncated size. Non-English speaking authors are additionally forced to map
...
(\ascl{1010.001}) and which use C routines
...
iRODS\footnote{\url{http://irods.org}} \citep[see e.g.,][]{2007AGUFMIN13B1214R}
...
(part of the \textsc{ftools} package; \ascl{9912.002})
...
discussions.  We thank Bob Hanisch and Michael Wise for providing
